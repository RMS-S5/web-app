      ...
      <CRow>
        <CCol>
          <CardContainer error={error} loading={loading} header="My Profile">
            ...
            <CContainer>
              <CRow>
                <CButton color="primary" className="mr-2" to="/manager/profile/edit"> {/*todo:add route */}
                  Edit
                </CButton>
                <CButton color="danger" to="/manager/change-password"> {/*todo:add route */}
                  Change Password
                </CButton>
              </CRow>
            </CContainer>
